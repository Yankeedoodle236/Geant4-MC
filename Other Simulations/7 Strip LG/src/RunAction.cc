  ...
  , fPrimary(prim)
{
  ...
  accumulableManager->RegisterAccumulable(fCounter_left);
  accumulableManager->RegisterAccumulable(fCounter_right);
...
void RunAction::EndOfRunAction(const G4Run*)
{
  ...
  G4int count_left = fCounter_left.GetValue();
  G4int count_right = fCounter_right.GetValue();
  ...
  G4cout << G4endl;
  G4cout << "Photons in left: " << count_left << G4endl;


  G4cout << G4endl;
  G4cout << "Photons in right: " << count_right << G4endl;
...
void RunAction::AddCount_left(G4int count_left)
{
  fCounter_left += count_left;
}

void RunAction::AddCount_right(G4int count_right)
{
  fCounter_right += count_right;
}
